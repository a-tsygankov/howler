...
**Last updated:** 2026-06-02 — through PR #49 (firmware idle/sleep + sync wake-skip + CI version bump). Recent arcs: **OTA Phase 6** end-to-end except HIL-3 hardware verification; **avatars** unified across home / users / tasks / labels on all three layers; **device power**: 5-min idle screen-sleep with peek-skip wake. Tests at backend 138 + firmware native 125. No open PRs.
